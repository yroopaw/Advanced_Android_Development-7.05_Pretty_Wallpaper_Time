    ...
    private class SimpleEngine  extends CanvasWatchFaceService.Engine
        ...
        public void onCreate(SurfaceHolder holder) {
          ...
          /*  Resources resources = PrettyWatchFace.this.getResources();
            ...
            mHighTempPaint = createPaint(resources.getColor(R.color.wear_temp_font_color),
                    resources.getDimension(R.dimen.temp_font_size));
            mLowTempPaint = new Paint();
            mLowTempPaint = createPaint(resources.getColor(R.color.wear_temp_font_color),
                    resources.getDimension(R.dimen.temp_font_size));
        ...
        public void onDraw(Canvas canvas, Rect bounds) {
            ...
            if(isInAmbientMode()) {
                canvas.drawColor(Color.YELLOW); // CHange later
            }
            else {
