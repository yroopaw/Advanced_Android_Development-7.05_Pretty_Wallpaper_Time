...
public class SunshineSyncAdapter extends AbstractThreadedSyncAdapter {
    ...
    public void sendWeatherDataToWearable() {

        // Get Weather Data from Cursor
        ...
        int dayWeather = cursor.getInt(INDEX_WEATHER_ID);

        putDataMapRequest.getDataMap().putString("max-temp", maxTemp);
        putDataMapRequest.getDataMap().putString("min-temp", minTemp);
